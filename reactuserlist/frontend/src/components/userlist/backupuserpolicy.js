...
const Userpolicylist = () => {
    ...
    const Submit = (e) => {
        e.preventDefault();
        const newRecord = ({ ...userPolicy, Id: new Date().getTime().toString() })
        console.log(newRecord)

        policyList.push(newRecord)
        setPolicyList(policyList);
        console.log(policyList)
        setUserPolicy({firstname: "", lastname: ""})
        // setUserPolicy({ firstname: "", lastname: "",country:"",zipcode:"", startdate: "", enddate: "" })
        // setInsurance("");
        // setTotalPremium("");
    }
    ...
    return (
        <div>
            <Form>
                ...
                {/* <Form.Select aria-label="Default select example" name="country" value={userPolicy.country} onChange={handleaddressChange}>
                ...
                <br />
                <Form.Group className="mb-3">
                    <Form.Control type="text" placeholder='Zip Code' name="zipcode" value={userPolicy.country} onChange={handleaddressChange} />
                </Form.Group>
                <Form.Check inline
                    label="in annual"
                    name="annual"
